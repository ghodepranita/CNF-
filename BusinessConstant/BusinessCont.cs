...
namespace CNF.Business.BusinessConstant
{
    public class BusinessCont
    {
        ...
        public static string msg_alreadyprocess = "Invoice Already Process!";
        public static string msg_dnotexst = "Invoice Does Not Exist!";
        public static string TransportSuccessStatus = "TransportSuccess";
        public static string TransportFailStatus = "TransportFail";
        public static string Transportmsg_exist = "TransportExists";
        public static string PrintSuccessStatus = "PrintSuccess";
        public static string PrintFailStatus = "PrintFail";
        public static string Printmsg_exist = "PrintExists";
        
        // New Notification for print
        public static string PrintStatusHeader = "Print Status";
        public static string PrintStatusMsg = "Printer not available";
        public static string UtilityStatusHeader = "Utility Status";
        public static string UtilityConnectedMsg = "Utility Connected";
        public static string UtilityNotConnectedMsg = "Utility Not Connected";
        public static string PayLoadPicker = "Picker";
        public static string PayLoadBilldrawer = "billDrawer";
        public static string PayLoadGateSupervisor = "gateSupervisor";
        ...
        public static string SPrinterType = "Sticker";
        public static string GPrinterType = "Gatepass";
        ...
        public static string msg_InvalidColumnName = "Invalid Column Name";
        public static string msg_InvalidInvDtsImported = "Invoice Details are invalid imported";
        public static string msg_InvalidNextDate = "Please Select Today's Date or Previous Date";

        /// <summary>
        /// Type Check With Data - New
        /// </summary>
        /// <param name="expectedDataType"></param>
        /// <param name="cellValue"></param>
        /// <param name="rownum"></param>
        /// <param name="insertflag"></param>
        /// <param name="columnErrorFlag"></param>
        /// <param name="columnErrorMessage"></param>

        public static void TypeCheckWithData(string expectedDataType, string cellValue, int rownum, ref bool insertflag, ref bool columnErrorFlag, ref string columnErrorMessage, bool isAlphanumeric=false)
        {
            try
            {
                switch (expectedDataType)
                {
                    ...
                    case "DateTime":
                        ...
                        break;
                    case "String":
                        Convert.ToString(cellValue);
                        break;
                    case "Decimal":
                        Convert.ToDecimal(cellValue);
                        break;
                    case "Long":
                        Convert.ToInt64(cellValue);
                        break;
                    case "Alphanumeric":
                         isAlphanumeric = IsAlphanumeric(expectedDataType, cellValue, rownum, ref insertflag, ref columnErrorFlag, ref columnErrorMessage);
                        break;
                    default:
                        break;
                }
            ...
            catch (Exception ex)
            {
                ...
                columnErrorMessage += "\n Row: " + rownum + "\n Value: " + cellValue + " \n ";
                SaveLog(0, 0, 0, "TypeCheckWithData", "Type Check With Data New", FailStatus, ExceptionMsg(ex));
            }
        }
        
        public static bool IsAlphanumeric(string expectedDataType, string cellValue, int rownum, ref bool insertflag, ref bool columnErrorFlag, ref string columnErrorMessage)
        {           
            string pattern = "^(?!0)[a-zA-Z0-9]+$";
            bool result = Regex.IsMatch(cellValue, pattern);
            if (result == false)
            {
                insertflag = false;
                columnErrorFlag = true;
